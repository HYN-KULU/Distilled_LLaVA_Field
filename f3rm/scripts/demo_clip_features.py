...
def demo_clip_features(text_query: str) -> None:
    ...
    print("Clip Image Embedding & Text Query Embedding: ",clip_embs.shape,text_embs.shape)
    # Compute similarities
    sims = clip_embs @ text_embs.T
    sims = sims.squeeze()
    print("Squeeze Similarity Shape: ",sims.shape)
    # Visualize
    plt.figure()
...
if __name__ == "__main__":
    demo_clip_features(text_query="mug handle")
